...
protected:
    ...
    rtengine::ProcEvent EvWBitcwbdel;
    ...
    sigc::connection methconn, itcwb_algconn, itcwb_delconn, itcwb_samplingconn, itcwb_primconn;
    int custom_temp;
    double custom_green;
    double custom_equal;
